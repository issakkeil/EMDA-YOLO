...
def bbox_alpha_iou(box1, box2, xywh=False, EIoU=False, alpha=2, eps=1e-7):
       # Get the coordinates of bounding boxes
    if xywh:  # transform from xywh to xyxyS
        (x1, y1, w1, h1), (x2, y2, w2, h2) = box1.chunk(4, -1), box2.chunk(4, -1)
        w1_, h1_, w2_, h2_ = w1 / 2, h1 / 2, w2 / 2, h2 / 2
        b1_x1, b1_x2, b1_y1, b1_y2 = x1 - w1_, x1 + w1_, y1 - h1_, y1 + h1_
        b2_x1, b2_x2, b2_y1, b2_y2 = x2 - w2_, x2 + w2_, y2 - h2_, y2 + h2_
    ...
    if EIoU:
        ...
        if EIoU:
            ...
            rho_w2 = torch.pow(rho_x ** 2, alpha)
            rho_h2 = torch.pow(rho_y ** 2, alpha)
...
class Metric(SimpleClass):
    ...
    def fitness(self):
        ...
        w = [0, 0, 0.1, 0.9]  # weights for [P, R, mAP@0.5, mAP@0.5:0.95]
